...
export const CONTROL_REQUEST_KIND_CANCEL_SESSION = 'cancelSession'
...
const CancelSessionRequestSchema = z.object({
  kind: z.literal(CONTROL_REQUEST_KIND_CANCEL_SESSION),
  sessionId: z.string(),
  invocationId: z.string().optional(),
})
...
export function createCancelSessionResponse(): ControlResponse {
  return {
    status: CONTROL_RESPONSE_STATUS_OK,
